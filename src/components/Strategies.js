  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 text-justify">
      ...
      <div className="mb-8">
        ...
        <p className="mb-2">
          {`If your hand totals 17 or more, it's generally best to <span className="font-bold">stand</span>.
           This is especially important when the dealer shows a strong upcard like 7, 8, 9, 10, or Ace. 
           Trying to hit with a hand like 17 or 18 is risky—there's a high chance of busting.`}
        </p>
      ...
      <div className="mb-8">
        ...
        <p className="mb-2">
          ...
          You can't bust, so there's no reason to avoid taking another card. The goal is to get closer to 21 without going over, and hands below 9 leave plenty of room for improvement.`}
        </p>
        <div tabIndex={0} className="collapse collapse-arrow bg-base-100 border-base-300 border">
            <div className="collapse-title font-semibold">Why?</div>
            <div className="collapse-content text-sm">
      ...
      <div className="mb-8">
        ...
        <p className="mb-2">
          ...
          This move allows you to double your bet in exchange for receiving just one more card.`}
        </p>
        <div tabIndex={0} className="collapse collapse-arrow bg-base-100 border-base-300 border">
            <div className="collapse-title font-semibold">Why?</div>
            <div className="collapse-content text-sm">
